...
export class AccountService {
  ...
  isEmailRegisterd(email: string): Observable<any> {
    return this.http.get<any>(this.appConfig.urls.url('isEmailRegisterd', email)).pipe(
    );
  }

  isTinUnique(tin: string): Observable<any> {
    return this.http.get<any>(this.appConfig.urls.url('isTinRegisterd', tin)).pipe(
    );
